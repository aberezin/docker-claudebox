...
API_TOKEN = os.environ.get("DRIDOCK_MODE_API_TOKEN", "")
_port_raw = os.environ.get("DRIDOCK_MODE_API_PORT", "8080")
try:
    PORT = int(_port_raw)
except ValueError:
...
def _build_env():
    return {
        **os.environ,
        ...
        "PATH": f"/home/claude/.claude/bin:/opt/claude-cli/bin:{os.environ.get('PATH', '')}",
    }
